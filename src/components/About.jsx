    ...
    return (
        <>
            ...
            <div className="p-4 pointer-events-auto grid grid-cols-5 gap-4 mt-10 rounded grid-rows-auto customBorder bg-customBGDark dark:bg-customBG mx-auto container-lg">
                ...
                <div
                    style={{ height: "300px" }}
                    className="col-span-5 sm:col-span-3 md:col-span-4 text-center mx-auto p-4 flex flex-col justify-center content-center rounded overflow-hidden customBorder"
                >
